...
local SSniper = Instance.new("ScreenGui")
...
SSniper.Name = "SSniper"
SSniper.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
SSniper.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
Drag.Position = UDim2.new(0, 376, 0, 164)
Drag.Size = UDim2.new(0, 624, 0, 25)
...
Main.Size = UDim2.new(0, 624, 0, 347)
...
Name.Position = UDim2.new(0, 0, -0.0749279559, 0)
Name.Size = UDim2.new(0, 623, 0, 26)
...
Field.Name = "Field"
Field.Parent = Main
Field.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
Field.BorderSizePixel = 0
Field.Position = UDim2.new(0, 12, 0, 0)
Field.Size = UDim2.new(0, 599, 0, 279)
Field.Font = Enum.Font.FredokaOne
Field.PlaceholderText = "-- Insert Script Here"
Field.Text = "-- Insert Script Here"
...
Exe.Name = "Exe"
Exe.Parent = Main
Exe.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
Exe.Position = UDim2.new(0, 12, 0, 286)
Exe.Size = UDim2.new(0, 116, 0, 49)
Exe.Font = Enum.Font.FredokaOne
Exe.Text = "Execute"
...
Hide.Name = "Hide"
Hide.Parent = Main
Hide.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
Hide.Position = UDim2.new(0, 136, 0, 286)
Hide.Size = UDim2.new(0, 116, 0, 49)
...
Cle.Name = "Cle"
Cle.Parent = Main
Cle.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
Cle.Position = UDim2.new(0, 260, 0, 286)
Cle.Size = UDim2.new(0, 116, 0, 49)
Cle.Font = Enum.Font.FredokaOne
Cle.Text = "Clear"
...
RE.Position = UDim2.new(0, 560, 0, 286)
RE.Size = UDim2.new(0, 51, 0, 49)
...
R6.Name = "R6"
R6.Parent = Main
R6.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
R6.Position = UDim2.new(0, 496, 0, 286)
R6.Size = UDim2.new(0, 51, 0, 49)
...
local function ILMY_fake_script() -- Drag.SmoothDrag 
...
coroutine.wrap(ILMY_fake_script)()
local function ZBVQ_fake_script() -- Exe.Script 
...
coroutine.wrap(ZBVQ_fake_script)()
local function UNWJZAV_fake_script() -- Exe.LocalScript 
...
coroutine.wrap(UNWJZAV_fake_script)()
local function AVFP_fake_script() -- Hide.LocalScript 
...
coroutine.wrap(AVFP_fake_script)()
local function BQTL_fake_script() -- Cle.LocalScript 
...
coroutine.wrap(BQTL_fake_script)()
local function KZAIHIX_fake_script() -- RE.LocalScript 
...
coroutine.wrap(KZAIHIX_fake_script)()
local function FEJHMM_fake_script() -- RE.ServerEvents 
...
coroutine.wrap(FEJHMM_fake_script)()
local function CTHQZ_fake_script() -- R6.LocalScript 
...
coroutine.wrap(CTHQZ_fake_script)()
local function SXBUOR_fake_script() -- nil.Script 
...
coroutine.wrap(SXBUOR_fake_script)()
